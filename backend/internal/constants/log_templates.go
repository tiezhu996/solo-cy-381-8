...
const (
	...
	LogPlanCreated          = "recurring plan created: plan_id=%d group_id=%d name=%s amount=%.2f day_of_month=%d operator_id=%d"
	LogPlanUpdated          = "recurring plan updated: plan_id=%d name=%s amount=%.2f day_of_month=%d operator_id=%d"
	LogPlanPaused           = "recurring plan paused: plan_id=%d operator_id=%d"
	LogPlanResumed          = "recurring plan resumed: plan_id=%d operator_id=%d"
	LogPlanRemoved          = "recurring plan removed: plan_id=%d operator_id=%d"
	LogPlanExpenseGenerated = "recurring plan expense generated: plan_id=%d period=%s expense_id=%d amount=%.2f"
	LogPlanGenerateSkipped  = "recurring plan generate skipped: plan_id=%d reason=%s"
